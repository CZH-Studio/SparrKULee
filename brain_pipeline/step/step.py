...
from brain_pipeline.default_keys import KeyTypeNotNone, KeyTypeNoneOk

class Step(ABC):
    def __init__(self, input_keys: KeyTypeNoneOk, default_input_keys: KeyTypeNotNone,
                 output_keys: KeyTypeNoneOk, default_output_keys: KeyTypeNotNone):
    ...
    def assert_keys(self, op1: str, input_num: int, op2: str, output_num: int):
